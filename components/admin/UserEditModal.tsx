                  ...
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input
                          ...
                          className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-3 py-2 sm:text-sm border-gray-600 rounded-md bg-gray-700 text-white"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={formData.city || ''}
                        onChange={handleChange}
                        className="focus:ring-blue-500 focus:border-blue-500 block w-full py-2 sm:text-sm border-gray-600 rounded-md bg-gray-700 text-white"
                      />
                    </div>
                    ...
                    <div className="md:col-span-2">
                      <label className="block text-sm font-medium text-gray-300">Suspension Reason</label>
                      <textarea
                  ...
                  <div className="mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="is_active" className="ml-2 block text-sm text-gray-300 flex items-center">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded focus:ring-blue-500 bg-gray-700 border-gray-600"
                        />
                        <label htmlFor="email_verified" className="ml-2 block text-sm text-gray-300 flex items-center">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded focus:ring-blue-500 bg-gray-700 border-gray-600"
                        />
                        <label htmlFor="account_locked" className="ml-2 block text-sm text-gray-300 flex items-center">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded focus:ring-blue-500 bg-gray-700 border-gray-600"
                        />
                        <label htmlFor="account_suspended" className="ml-2 block text-sm text-gray-300 flex items-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded focus:ring-blue-500 bg-gray-700 border-gray-600"
                        />
                        <label htmlFor="marketing_consent" className="ml-2 block text-sm text-gray-300">
                          Marketing Emails
                        </label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded focus:ring-blue-500 bg-gray-700 border-gray-600"
                        />
                        <label htmlFor="newsletter_consent" className="ml-2 block text-sm text-gray-300">
                          Newsletter
                        </label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded focus:ring-blue-500 bg-gray-700 border-gray-600"
                        />
                        <label htmlFor="privacy_consent" className="ml-2 block text-sm text-gray-300">
                          Privacy Policy
                        </label>
                      </div>
                    </div>
