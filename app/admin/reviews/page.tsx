            ...
            <table className="min-w-full divide-y divide-gray-700">
              <thead className="bg-gray-700">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Review</th>
              ...
              <tbody className="divide-y divide-gray-700">
                {reviews.map((review: any) => (
                  <tr key={review.id} className="hover:bg-gray-750">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-300">{review.customer_name}</div>
                      <div className="text-sm text-gray-400">{review.customer_email}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-300 max-w-xs truncate" title={review.review_text}>
